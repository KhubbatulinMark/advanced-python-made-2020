...
class EncodedFileType(FileType):
    ...
    def __call__(self, string):
        ...
        try:
            ...
            raise ArgumentTypeError(message % (string, Exceptions)) from Exceptions
...
def query_callback(arguments):
    """Function for callback for queries to the invested index"""
    if arguments.query:
